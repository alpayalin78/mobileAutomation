...
public class ReactionToShortsLike extends AndroidBaseTest {
    ...
    @Test
    public void dislike_shorts() throws InterruptedException, IOException {
        Integer value = (Integer) this.testData.get("searchKey_1");
        this.shortsPage.go_to_shorts_page();
        this.shortsPage.like_reaction(value, this.uuid_to);
