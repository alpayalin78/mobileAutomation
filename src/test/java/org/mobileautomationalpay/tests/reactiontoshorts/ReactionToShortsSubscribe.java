...
public class ReactionToShortsSubscribe extends AndroidBaseTest {
    ...
    @Test
    public void subscribe_through_shorts() throws InterruptedException, IOException {
        Integer value = (Integer) this.testData.get("searchKey_1");
        this.shortsPage.subscribe_account(value, this.uuid_to);
