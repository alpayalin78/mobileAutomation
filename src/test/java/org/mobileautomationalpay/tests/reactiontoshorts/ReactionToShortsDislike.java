...
public class ReactionToShortsDislike extends AndroidBaseTest {
    ...
    @Test
    public void like_shorts() throws InterruptedException, IOException {
        Integer value = (Integer) this.testData.get("searchKey_1");
        this.shortsPage.dislike_reaction(value, this.uuid_to);
